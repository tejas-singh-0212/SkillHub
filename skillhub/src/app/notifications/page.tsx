...
export default function NotificationsPage() {
 ...
 const formatDate = (timestamp: AppNotification["createdAt"]): string => {
 ...
 className={`bg-white dark:bg-gray-800 border dark:border-gray-700 rounded-xl p-4 cursor-pointer hover:shadow-md dark:shadow-none transition ${
 ...
 !notif.isRead ? "text-blue-800" : "text-gray-800 dark:text-gray-100"
 }`}
 >
 {notif.title}
 </h3>
