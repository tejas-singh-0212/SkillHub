...
export default function DashboardPage() {
 ...
 <p className="text-gray-600 dark:text-gray-300">Here&apos;s your SkillHub overview</p>
 </div>
 ...
 <p className="text-gray-600 dark:text-gray-300 text-sm mt-1">Skills Offered</p>
 </div>
 <div className="bg-white dark:bg-gray-800 rounded-xl p-5 border dark:border-gray-700">
 <p className="text-3xl font-bold text-green-600">
 {profile.skillsNeeded?.length || 0}
 </p>
 <p className="text-gray-600 dark:text-gray-300 text-sm mt-1">Skills Needed</p>
 </div>
 <div className="bg-white dark:bg-gray-800 rounded-xl p-5 border dark:border-gray-700">
 ...
 className="bg-white dark:bg-gray-800 border dark:border-gray-700 rounded-xl p-4 hover:shadow-lg dark:shadow-none transition"
 >
