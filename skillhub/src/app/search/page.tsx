...
import type { SearchResult, ClientLocation } from "@/types";
...
function SearchContent() {
 ...
 name: r.name,
 avatar: r.avatar,
 lat: r.location!.latitude || r.location!.lat || 0,
 lng: r.location!.longitude || r.location!.lng || 0,
 ...
 {/* Location Status */}
 {!userLocation && (
 <div className="bg-yellow-50 border dark:border-gray-700 border-yellow-200 rounded-xl p-4 mb-6">
 ...
 radiusInKm={radius}
 onMarkerClick={(person: { id: string }) => router.push(`/profile/${person.id}`)}
 />
 </div>
 )}
 ...
 className="bg-white dark:bg-gray-800 border-2 border-blue-600 text-blue-600 px-8 py-3 rounded-xl font-semibold hover:bg-blue-50 transition disabled:opacity-50"
 >
 {loadingMore ? (
 ...
 className="bg-white dark:bg-gray-800 rounded-xl p-4 text-center hover:shadow-md dark:shadow-none transition border dark:border-gray-700 hover:border-blue-300"
 >
