...
const [uploadingImage, setUploadingImage] = useState(false);
 ...
 // Edit Needed Skill
 const [editingNeeded, setEditingNeeded] = useState<string | null>(null);
 ...
 toast.error("Error adding skill: " + (err as Error).message);
 }
 };

 const handleRemoveOffered = async (skill: SkillOffered) => {
 ...
 toast.error("Error removing skill: " + (err as Error).message); 
 }
 };

 const handleStartEditOffered = (skill: SkillOffered) => {
 ...
 toast.error("Error updating skill: " + (err as Error).message); 
 }
 };
 ...
 const handleRemoveNeeded = async (skill: SkillNeeded) => {
 ...
 const handleStartEditNeeded = (skill: SkillNeeded) => {
 ...
 <div className="flex flex-col sm:flex-row items-center gap-4 mb-6 pb-6 border-b dark:border-gray-700">
 <Image
 unoptimized
 src={
 profile.avatar ||
 ...
 className="w-full border dark:border-gray-700 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-blue-500"
 />
 </div>
 <div>
 ...
 rows={3}
 className="w-full border dark:border-gray-700 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-blue-500 resize-none"
 />
 </div>
 <div>
 ...
 className="border dark:border-gray-700 rounded-lg px-4 py-2"
 >
 ...
 className="flex-1 border dark:border-gray-700 py-2 rounded-lg hover:bg-gray-50 dark:bg-gray-900"
 >
 Cancel
 </button>
 <button
 ...
 className="flex-1 border dark:border-gray-700 py-2 rounded-lg"
 >
 Cancel
 </button>
 <button
 ...
 className="w-full border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl py-3 text-gray-600 dark:text-gray-300 hover:border-green-400 hover:text-green-600 transition"
 >
 + Add Skill Needed
 </button>
 )}
