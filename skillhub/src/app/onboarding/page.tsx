...
import type { ClientLocation, NewSkillOfferedInput, NewSkillNeededInput } from "@/types";
...
const LocationPicker = dynamic(
 ...
 ssr: false,
 loading: () => (
 <div className="h-[300px] bg-gray-100 dark:bg-gray-800 rounded-xl flex items-center justify-center">
 <p className="text-gray-500 dark:text-gray-400">🗺️ Loading map...</p>
 </div>
 ),
 }
);
...
export default function OnboardingPage() {
 ...
 const [offeredSkills, setOfferedSkills] = useState<NewSkillOfferedInput[]>([]);
 ...
 const [neededSkills, setNeededSkills] = useState<NewSkillNeededInput[]>([]);
 ...
 toast.error("Error saving profile: " + (err as Error).message);
 } finally {
 setSaving(false);
 }
 };
 ...
 <p className="text-gray-600 dark:text-gray-300 text-center mb-8">Step {step} of 4</p>
 ...
 className="w-full border dark:border-gray-700 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 outline-none"
 />
 </div>
 ...
 rows={3}
 className="w-full border dark:border-gray-700 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 outline-none resize-none"
 />
 </div>
 ...
 {location && (
 <div className="bg-green-50 border dark:border-gray-700 border-green-200 rounded-xl p-4">
 ...
 <button
 onClick={() => setStep(1)}
 className="flex-1 border dark:border-gray-700 border-gray-300 dark:border-gray-600 py-3 rounded-xl font-medium hover:bg-gray-50 dark:bg-gray-900"
 >
 ← Back
 </button>
 <button
 ...
 className="w-full border dark:border-gray-700 rounded-lg px-4 py-2 outline-none focus:ring-2 focus:ring-blue-500"
 />
 ...
 className="w-full border dark:border-gray-700 rounded-lg px-4 py-2"
 >
 ...
 rows={2}
 className="w-full border dark:border-gray-700 rounded-lg px-4 py-2 resize-none outline-none focus:ring-2 focus:ring-blue-500"
 />
 ...
 className="border dark:border-gray-700 rounded-lg px-4 py-2 h-[42px]"
 >
 ...
 className="flex-1 border dark:border-gray-700 py-2 rounded-lg hover:bg-gray-50 dark:bg-gray-900 transition"
 >
 Cancel
 </button>
 <button
 ...
 className="w-full border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl py-4 text-gray-600 dark:text-gray-300 font-medium hover:border-blue-400 hover:text-blue-600 hover:bg-blue-50 transition"
 >
 ...
 <button
 onClick={() => setStep(2)}
 className="flex-1 border dark:border-gray-700 border-gray-300 dark:border-gray-600 py-3 rounded-xl font-medium hover:bg-gray-50 dark:bg-gray-900 transition"
 >
 ← Back
 </button>
 <button
 ...
 className="w-full border dark:border-gray-700 rounded-lg px-4 py-2 outline-none focus:ring-2 focus:ring-green-500"
 />
 <select
 ...
 rows={2}
 className="w-full border dark:border-gray-700 rounded-lg px-4 py-2 resize-none outline-none focus:ring-2 focus:ring-green-500"
 />
 ...
 className="w-full border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl py-4 text-gray-600 dark:text-gray-300 font-medium hover:border-green-400 hover:text-green-600 hover:bg-green-50 transition"
 >
