...
export default function RegisterPage() {
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      ...
      // Step 2: OTP verified — now create the Firebase account
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold">
            {step === "details" ? "Join SkillHub 🚀" : "Verify Your Email 📧"}
          </h1>
          <p className="text-gray-600 dark:text-gray-300 mt-2">
            {step === "details"
              ? "Start exchanging skills in your community"
          ...
          {step === "details" ? (
            <>
              ...
              <button
                ...
                disabled={loading}
                className="w-full flex items-center justify-center gap-3 border-2 border-gray-200 dark:border-gray-700 rounded-xl py-3 hover:bg-gray-50 dark:bg-gray-900 transition font-medium disabled:opacity-50"
              >
            ...
            <div className="animate-fade-in">
                ...
                {otp.map((digit, index) => (
                  <input
                    ...
                    className={`w-11 h-13 sm:w-13 sm:h-14 text-center text-xl sm:text-2xl font-bold rounded-xl border-2 outline-none transition-all duration-200
                      ${
                        digit
                          ? "border-green-500 bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-300 shadow-sm shadow-green-200 dark:shadow-green-900/50"
              ...
              <button
                ...
                className="w-full bg-green-600 text-white py-3 rounded-xl font-semibold hover:bg-green-700 transition disabled:opacity-50 mb-4"
              >
                {loading ? (
