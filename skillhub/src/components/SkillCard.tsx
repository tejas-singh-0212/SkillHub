...
export default function SkillCard({ skill, onBook, onRemove }: SkillCardProps) {
 ...
 return (
 <div className="bg-white dark:bg-gray-800 border dark:border-gray-700 rounded-xl p-4 hover:shadow-md dark:shadow-none transition">
 ...
 {skill.description && <p className="text-sm text-gray-600 dark:text-gray-300 mt-2">{skill.description}</p>}
 ...
 💰 ₹{skill.price}{" "}
 <span className="text-gray-500 dark:text-gray-400 font-normal">{perUnit?.label || skill.perUnit}</span>
 </span>
 )}
 </span>
 {onBook && (
