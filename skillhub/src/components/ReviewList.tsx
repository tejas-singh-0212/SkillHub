...
export default function ReviewList({ reviews }: ReviewListProps) {
 ...
 {reviews.map((review) => (
 <div key={review.id} className="bg-white dark:bg-gray-800 border dark:border-gray-700 rounded-xl p-4">
 ...
 {review.comment && <p className="text-gray-700 dark:text-gray-200 text-sm mt-2">{review.comment}</p>}
