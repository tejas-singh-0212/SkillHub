...
export default function ReviewForm({ bookingId, revieweeId, onComplete }: ReviewFormProps) {
 ...
 <textarea value={comment} onChange={(e) => setComment(e.target.value)} placeholder="How was your experience?" rows={3} className="w-full border dark:border-gray-700 rounded-lg px-4 py-2 resize-none outline-none focus:ring-2 focus:ring-blue-500 transition-shadow" />
 </div>
